(function (LiteGraph) {
  ...
  LiteGraph.addIecDataType = function (dataTypeAsString) {
    try {
      let iecDataType = iec.fromString(
        dataTypeAsString,
        null,
        this.iecDataTypes
      );
  ...
  LiteGraph.LGraphCanvas.prototype.onShowMenuNodeProperties =
    LiteGraph.LGraphCanvas.onShowMenuNodeProperties;
  LiteGraph.LGraphCanvas.prototype.onShowPropertyEditor =
    LiteGraph.LGraphCanvas.onShowPropertyEditor;
})(LiteGraph);
